...
<!-- Mirrored from themescare.com/demos/bleezy/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 09:24:56 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    
    <!-- Title -->
   <title>Flash - Security Service Company </title>
    <!-- Favicon -->
...
<body>
    ...
    <?php /*?><section class="bleezy-contact-form-area section_b_100">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
    ...
    <!-- Gmap Start -->
    <?php /*?><div class="map-canvas" data-zoom="12" data-lat="-37.817085" data-lng="144.955631" data-type="roadmap" data-hue="#ffc400" data-title="Envato" data-icon-path="assets/img/marker.png" data-content="Melbourne VIC 3000, Australia<br><a href='mailto:info@youremail.com'>info@youremail.com</a>"></div>
    <!-- Gmap Start --><?php */?>
